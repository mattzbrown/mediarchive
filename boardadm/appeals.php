<?
$pagetitle="Forwarded Contests Queue";
...
<tr><td COLSPAN=5 align=center><FONT SIZE=6><B>Forwarded Contest Queue</b></font></td></tr>
...
<td CLASS=LITE ALIGN=center><i>Forward Date</i></td>
</tr>
<tr><td CLASS=DARK colspan=5 ALIGN=center>Appealed Moderations</td></tr>";
$result=mysql_query("SELECT * FROM modded WHERE contest=1 AND recont=4 ORDER BY contsec ASC");
...
echo "<tr><td CLASS=DARK colspan=5 ALIGN=center>Forwarded Moderations</td></tr>";
$result=mysql_query("SELECT * FROM modded WHERE contest=1 AND recont=9 ORDER BY contsec ASC");
while ($myrow=@mysql_fetch_array($result)) {
